...
//sendComment (to,message,consistency )

//чтобы из эфира в тон кидать

//relay comment func (энкодид ваа, парсинг энд верифай ваа,берешь ваа, достаешь коммент и кому

//через гет метод вызвать и посмотреть