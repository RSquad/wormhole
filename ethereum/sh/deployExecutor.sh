...
# Usage: RPC_URL= MNEMONIC= EVM_CHAIN_ID= ./sh/deployExecutor.sh
...
forge script ./forge-scripts/DeployExecutor.s.sol:DeployExecutor \
	--sig "run()" \
	--rpc-url "$RPC_URL" \
...
echo "Deployed Executor to address: $EXECUTOR_ADDRESS"
